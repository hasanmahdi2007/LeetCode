<h2><a href="https://leetcode.com/problems/swim-in-rising-water/?envType=problem-list-v2&envId=22fmu8yh">794. Swim in Rising Water</a></h2><h3>Hard</h3><hr><p>You are given an <code>n x n</code> integer matrix <code>grid</code> where each value <code>grid[i][j]</code> represents the elevation at that point <code>(i, j)</code>.</p>
